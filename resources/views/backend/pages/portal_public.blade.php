...
<body>
    ...
    <div class="portal-container mt-5">
        ...
        <div class="portal-cards">
            ...
            <!-- Accounting System -->
            <a href="{{ route('accounting.login') }}" target="_blank" class="portal-card">
                <div class="portal-icon" style="color: #0ea5e9; background: #e0f2fe;">
                    <i class="bi bi-calculator-fill"></i>
                </div>
                <h3>Accounting System</h3>
                <p>Secure financial portal. Manage budgets, journal entries, bank accounts, expenses, and financial reports.</p>
            </a>
        </div>
