                        ...
                        @forelse($types as $type)
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <form action="{{ route('sms.finance.fee-types.destroy', $type->id) }}" method="POST" class="d-inline-block" onsubmit="return confirm('Delete this fee type?');">
                                        @csrf @method('DELETE')
...
<div class="modal fade" id="typeModal" tabindex="-1">
    <div class="modal-dialog">
        <form action="{{ route('sms.finance.fee-types.store') }}" method="POST" id="typeForm">
            @csrf
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    addBtn.addEventListener('click', function () {
        isEditMode = false;
        form.reset();
        form.action = "{{ route('sms.finance.fee-types.store') }}";
