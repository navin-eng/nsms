...
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-md-6">
            <h3 class="mb-0">Fee Structures</h3>
            <p class="text-muted">Manage the fee amounts assigned to classes and years.</p>
        </div>
        <div class="col-md-6 text-end">
            <button class="btn btn-outline-secondary me-2" data-bs-toggle="modal" data-bs-target="#copyStructureModal">
                <i class="bi bi-files"></i> Copy Structure
            </button>
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#structureModal" id="addStructureBtn">
                <i class="bi bi-plus-lg"></i> Add Fee Structure
            </button>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body p-4">
            <form method="GET" action="{{ route('sms.finance.fee-structures.index') }}" class="row g-3">
                <div class="col-md-3">
                        ...
                        @forelse($structures as $structure)
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <form action="{{ route('sms.finance.fee-structures.destroy', $structure->id) }}" method="POST" class="d-inline-block" onsubmit="return confirm('Delete this fee structure?');">
                                        @csrf @method('DELETE')
...
<div class="modal fade" id="structureModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <form action="{{ route('sms.finance.fee-structures.store') }}" method="POST" id="structureForm">
            @csrf
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-muted small mb-2">Leave amount blank or 0 for fee types that do not apply to this class. <br>
                        <em>Missing a fee type? <a href="{{ route('sms.finance.fee-types.index') }}" class="text-primary">Click here to add more fee types</a> first.</em>
                    </p>
...
<div class="modal fade" id="copyStructureModal" tabindex="-1">
    <div class="modal-dialog">
        <form action="{{ route('sms.finance.fee-structures.copy') }}" method="POST">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    addBtn.addEventListener('click', function () {
        form.reset();
        form.action = "{{ route('sms.finance.fee-structures.store') }}";
