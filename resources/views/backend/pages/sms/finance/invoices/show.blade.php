...
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-md-6">
            <h3 class="mb-0">Invoice #{{ str_pad($invoice->id, 5, '0', STR_PAD_LEFT) }}</h3>
        </div>
        <div class="col-md-6 text-end">
            <a href="{{ route('sms.finance.invoices.index') }}" class="btn btn-outline-secondary me-2">Back to Invoices</a>
            <div class="btn-group">
                <a href="{{ route('sms.finance.invoices.print', ['invoice' => $invoice->id, 'size' => 'a4']) }}" target="_blank" class="btn btn-primary">
                    <i class="bi bi-printer"></i> Print A4
                </a>
                <a href="{{ route('sms.finance.invoices.print', ['invoice' => $invoice->id, 'size' => 'a5']) }}" target="_blank" class="btn btn-outline-primary">
                    <i class="bi bi-printer"></i> Print A5
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-4">
            @if($invoice->status != 'Paid')
                <div class="card border-0 shadow-sm d-print-none">
                    ...
                    <div class="card-body">
                        <form action="{{ route('sms.finance.payments.store') }}" method="POST">
                            @csrf
