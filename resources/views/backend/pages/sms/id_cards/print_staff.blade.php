...
<body class="theme-{{ $template }}">
    ...
    @foreach($chunks as $chunk)
        <div class="page-container">
            @foreach($chunk as $st)
                @php
                    $verifyUrl = route('verification.show', ['token' => 'id_staff_' . $st->id . '_' . substr(md5($st->id . config('app.key')), 0, 8)]);
                    ...
                    <div class="id-card id-card-portrait">
                        ...
                        <div class="id-body portrait-body">
                            <div class="avatar-box">
                                @if($st->photo)
                                    <img src="{{ asset('uploads/staff/' . $st->photo) }}">
                                @else
                            ...
                            <div><span class="id-badge">{{ $st->department?->name ?? 'Department' }}</span></div>
                            ...
                            <table class="info-table">
                                ...
                                <tr>
                                    ...
                                    <td class="info-value">{{ $st->designation?->name ?? '—' }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="info-label">Blood Grp:</td>
                    ...
                    <div class="id-card id-card-landscape">
                        ...
                        <div class="id-body landscape-body">
                            ...
                            <div class="landscape-info">
                                <div class="staff-name" style="font-size: 10pt; margin-top:0;">{{ $st->full_name }}</div>
                                <div style="margin-bottom: 2px;"><span class="id-badge"
                                        style="font-size: 7pt;">{{ $st->department?->name ?? 'Department' }}</span></div>

                                <table class="info-table" style="font-size: 6.5pt;">
                                    <tr>
                                        <td class="info-label" style="width:30%;">Staff ID:</td>
                                        <td class="info-value">{{ $st->admission_no ?? '#' . $st->id }}</td>
                                    </tr>
                                    <tr>
                                        <td class="info-label">D.O.B:</td>
