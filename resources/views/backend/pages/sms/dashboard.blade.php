...
@php
  ...
  $results = App\Models\ExamResult::count();
@endphp
...
<div class="row g-3 mb-4">
  <div class="col-6 col-md-4 col-xl-3">
    <a href="{{ route('exam.index') }}" class="stat-card">
  ...
  <div class="col-lg-4">
    <div class="admin-card h-100">
      ...
      <div class="admin-card-body">
        <div class="qa-list">
          <a href="{{ route('exam.index') }}" class="quick-link">
          ...
          <a href="#" class="quick-link" onclick="alert('Student Information System is coming in Phase 2'); return false;">
  ...
  <div class="col-lg-8">
    <div class="admin-card h-100">
      <div class="admin-card-header">
        ...
        <a href="{{ route('exam.index') }}" class="btn-admin btn-admin-sm btn-admin-outline">
          View All
        </a>
      </div>
        ...
        <table class="admin-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="{{ route('exam.show', $exam->id) }}" class="btn-admin btn-admin-sm btn-admin-light">Manage Results</a>
              </td>
            </tr>
            @empty
            <tr>
