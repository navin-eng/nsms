...
<head>
    ...
    <title>Bulk Mark Sheets - {{ $class->name }}</title>
    ...
    <style>
        ...
        .marksheet-container {
            ...
            /* Force page break after each report card */
        }

        .marksheet-container:last-child {
            page-break-after: auto;
            /* No page break after the very last one */
        }
...
<body>
    <div class="d-print-none text-center py-3 bg-light border-bottom mb-4 sticky-top">
        <button onclick="window.print()" class="btn btn-primary px-4"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                height="16" fill="currentColor" class="bi bi-printer me-2" viewBox="0 0 16 16">
                <path d="M2.5 8a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1z" />
                <path
                    d="M5 1a2 2 0 0 0-2 2v2H2a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h1v1a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2v-1h1a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-1V3a2 2 0 0 0-2-2H5zM4 3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v2H4V3zm1 5a2 2 0 0 0-2 2v1H2a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-1v-1a2 2 0 0 0-2-2H5zm7 2v3a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1z" />
            </svg> Print All Mark Sheets</button>
            ...
            <div class="marksheet-container">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <h4
                            class="fw-bold mt-4 mb-0 text-uppercase border border-dark rounded-pill d-inline-block px-4 py-1">
                            {{ $exam->title }}
                        </h4>
                        ...
                        <div class="col-8">
                            <table class="table table-sm table-borderless mb-0">
                                <tr>
                                    ...
                                    <td class="fw-bold border-bottom border-dark border-1 rounded-0">
                                ...
                                <tr>
                                    ...
                                    <td class="border-bottom border-dark border-1 rounded-0">
                                        {{ $exam->academicYear->name ?? 'N/A' }}</td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-4">
                            <table class="table table-sm table-borderless mb-0">
                                ...
                                <tr>
                                    ...
                                    <td class="border-bottom border-dark border-1 rounded-0">
                                        {{ $student->dob ? $student->dob->format('Y-m-d') : '-' }}</td>
                                </tr>
                                <tr>
                                    <th class="text-start text-primary">Class Rank:</th>
                                    <td class="border-bottom border-dark border-1 rounded-0 fw-bold text-primary">
                                        {{ $studentResult->rank ?? '-' }}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="row mb-5">
                        <div class="col-6">
                            ...
                            <div class="mt-2 fw-bold text-center border border-dark p-2 rounded">
                                Result: <span
                                    class="{{ $isFail ? 'text-danger' : 'text-success' }} text-uppercase">{{ $isFail ? 'Fail' : 'Pass' }}</span>
                                <br>
                            ...
                            <table class="table table-sm table-bordered border-dark mb-0" style="font-size: 11px;">
                                ...
                                <tbody>
                                    @foreach($gradingRules->take(5) as $rule)
                                        <tr>
                                            <td class="py-1">{{ number_format($rule->min_percent, 0) }} -
                                                {{ number_format($rule->max_percent, 0) }}</td>
