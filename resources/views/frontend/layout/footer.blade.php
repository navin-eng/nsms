...
<style>
    .gplc-footer {
        background: #0a1a0c;
        /* Keep it dark regardless of theme */
        color: rgba(255, 255, 255, 0.65);
        padding: 0;
    }

    .gplc-footer-brand img {
        margin-bottom: 14px;
    }
    ...
    .gplc-footer-contact li i {
        color: #52b788;
        margin-top: 2px;
        min-width: 16px;
    }

    .gplc-footer-contact a {
        color: rgba(255, 255, 255, 0.6);
        text-decoration: none;
    }

    .gplc-footer-contact a:hover {
        color: #52b788;
    }
    ...
    .gplc-footer-bottom a {
        color: #52b788;
        text-decoration: none;
    }

    .gplc-footer-bottom a:hover {
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="gplc-footer-brand">
                    <img src="{{ \App\Models\SiteSetting::current()->site_logo ? asset('storage/' . \App\Models\SiteSetting::current()->site_logo) : asset('backend/images/logo.png') }}"
                        width="110" alt="GPLC Logo">
                    <p>{{ $siteSettings->site_name }}, providing quality education and shaping future leaders in
                    ...
                    <div class="gplc-footer-social">
                        ...
                        <a href="https://wa.me/{{ $siteSettings->whatsapp_number }}" target="_blank"><i
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <ul class="gplc-footer-contact list-unstyled">
                    ...
                    <li><i class="fa-solid fa-phone"></i> <a
                            href="tel:{{ $siteSettings->contact_phone }}">{{ $siteSettings->contact_phone }}</a></li>
                    <li><i class="fa-solid fa-envelope"></i> <a
                            href="mailto:{{ $siteSettings->contact_email }}">{{ $siteSettings->contact_email }}</a></li>
                    <li><i class="fa-brands fa-whatsapp"></i> <a
                            href="https://wa.me/{{ $siteSettings->whatsapp_number }}">+977
                            {{ $siteSettings->whatsapp_number }}</a></li>
                </ul>
            </div>
