...
class FeeInvoiceController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('accounting.fees.invoices.index', compact('invoices'));
    }
    ...
    public function generateIndex(Request $request)
    {
        ...
        return view('accounting.fees.invoices.generate', compact('years', 'classes', 'students', 'structures'));
    }
    ...
    public function generateProcess(Request $request)
    {
        ...
        try {
            ...
            if ($generatedCount > 0) {
                return redirect()->route('accounting.fees.invoices.index')->with('success', "Successfully generated $generatedCount invoices and posted journal entries.");
            } else {
    ...
    public function show(FeeInvoice $invoice)
    {
        ...
        return view('accounting.fees.invoices.show', compact('invoice'));
    }
    ...
    public function print(Request $request, FeeInvoice $invoice)
    {
        ...
        return view('accounting.fees.invoices.print', compact('invoice', 'paperSize'));
    }
}
